...
var myLayout = function () {
  ...
  function () {
    ...
    regeneratorRuntime.mark(function _callee(url) {
      var response, doggyData, dogsGrid;
  ...
  function () {
    ...
    regeneratorRuntime.mark(function _callee2() {
      var response, json, dropDownList;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 5:
              json = _context2.sent;
              dropDownList = Object.keys(json.message).map(function (ele) {
                // console.log(ele)
                return "<li><a href=\"#!\">".concat(ele, "</a></li>");
              });
              document.querySelector('#dropdown1').innerHTML = dropDownList.join('');

              _materializeCss.default.Dropdown.init(document.querySelectorAll('.dropdown-trigger'));

              document.querySelectorAll('#dropdown1 li a').forEach(function (ele) {
    ...
    return function fetchAllBreeds() {
...
document.getElementById('btn-search').addEventListener('click', function () {
  var breed = document.getElementById('breed_search').value;
  if (breed !== '') myLayout.fetchDog("".concat(BASE_URL, "breed/").concat(breed, "/images/random"));
});

var modalInstance = _materializeCss.default.Modal.init(document.querySelector('#loginModal'), {
  dismissible: false
});

document.querySelector('#loginModal .modal-footer a').addEventListener('click', function () {
  var usrname = document.querySelectorAll('#loginModal input')[0];
  var usrpwd = document.querySelectorAll('#loginModal input')[1];
...
document.querySelectorAll('.mdl').forEach(function (ele) {
...
},{"materialize-css":"../node_modules/materialize-css/dist/js/materialize.js","babel-polyfill":"../node_modules/babel-polyfill/lib/index.js","./style.css":"style.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
